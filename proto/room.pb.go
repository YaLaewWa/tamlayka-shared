...
func (x *EndRoomRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
const file_room_proto_rawDesc = "" +
	...
	"\f_summary_url\" \n" +
	"\x0eEndRoomRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id2\x7f\n" +
	"\vRoomService\x12:\n" +
	"\n" +
	"UpdateRoom\x12\x12.UpdateRoomRequest\x1a\x16.google.protobuf.Empty\"\x00\x124\n" +
	"\aEndRoom\x12\x0f.EndRoomRequest\x1a\x16.google.protobuf.Empty\"\x00B+Z)github.com/YaLaewWa/tamlayka-shared/protob\x06proto3"
...
var file_room_proto_goTypes = []any{
	...
	(*EndRoomRequest)(nil),    // 1: EndRoomRequest
	(*emptypb.Empty)(nil),     // 2: google.protobuf.Empty
}
var file_room_proto_depIdxs = []int32{
	0, // 0: RoomService.UpdateRoom:input_type -> UpdateRoomRequest
	1, // 1: RoomService.EndRoom:input_type -> EndRoomRequest
	2, // 2: RoomService.UpdateRoom:output_type -> google.protobuf.Empty
	2, // 3: RoomService.EndRoom:output_type -> google.protobuf.Empty
